...
const string& Encoder::encodePath(const GridMap::GridVector& path)
{
...
const string& Encoder::encodeAttack(int targetId)
{
...
const string& Encoder::encodeCreate(int unitType, const Grid& createGrid)
{
	char buff[20];
...
const string& Encoder::encodeChat(string& chatMessage)
{
