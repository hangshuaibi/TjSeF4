...
bool UnitManager::initWithScene(MainScene* mainScene)
{
	...
	_displayValueLabel1 = mainScene->_displayValueLabel1;
	_displayValueLabel2 = mainScene->_displayValueLabel2;
	...
	assert(_displayValueLabel1 != nullptr);
	assert(_displayValueLabel2 != nullptr);
